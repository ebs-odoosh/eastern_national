...
class ExportDataViews(models.Model):
    ...
    def get_hrjob_data_list(self):
        ...
        for job in jobs:
            ...
            JOB_ISCO_CODE = job.isco_code and job.isco_code.name or ''
            JOB_ENTRY_QUALIFICATION = ''
            JOB_OCH_INDUSTRY = ''
            JOB_OCH_OCCUPATION = ''
            JOB_QUALIFICATION_TITLE = ''
            JOB_START_DATE = job.employee_ids and job.employee_ids[0].time_hired or ''
            JOB_END_DATE = ''
            data_dict.update({'JOB_CODE': JOB_CODE,
                              'JOB_NAME': JOB_NAME,
                              'JOB_NAME_ARABIC': JOB_NAME_ARABIC,
                              'JOB_GRADE': JOB_GRADE,
    ...
    def get_emp_contacts(self):
        ...
        for employee_id in employee_ids:
            data_dict = {}
            EMPLOYEE_ID = employee_id.system_id or ''
            CONTACT_EMAIL_ID = employee_id.private_email or ''
    ...
    def get_hr_compensation(self):
        ...
        for compensation in compensations:
            ...
            CONTRACT_TYPE = compensation.related_contract and compensation.related_contract.contract_type and compensation.related_contract.contract_type.name or ''
            ELEMENT_TYPE = ''
    ...
    def get_emp_termination(self):
        ...
        for termination in hr_resignation_obj_records:
            data_dict = {}
            employee_id = termination.related_employee.name or ''
    ...
    def get_emp_assignments(self):
        ...
        for emp_event in emp_event_records:
            ...
            change_reason_desc = emp_event.event_reason and emp_event.event_reason.name or ''
            superviser_name = emp_event.line_manager_id and emp_event.line_manager_id.name or ''
