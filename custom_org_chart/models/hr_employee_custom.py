    ...
    def write_strata_csv_file(self):
        ...
        if sap_folder_path:
            ...
            with open(path + 'EMD_' + today + '.csv', 'w', newline='') as file:
                ...
                writer.writerow(fieldnames)
                for event in events:
                    employee_id = event.employee_strata_id if event.employee_strata_id else ''
                    ...
                    line_manager_id = event.line_manager_id_fkey.strata_id if event.line_manager_id_fkey.strata_id else ''
            ...
            with open(path + 'ESD_' + today + '.csv', 'w', newline='') as file:
                ...
                for event in events:
                    ...
                    if is_hire:
                        employee_id = event.related_event.employee_id.strata_id if event.related_event.employee_id.strata_id else ''
